...
class FTPContext {  
     ...
     * 
     * @param {number} [timeoutMillis=0]  Timeout to apply to control and data connections. Use 0 for no timeout.
     */
    ...
    set socket(socket) {
        ...
        if (this._socket) {
            ...
            this._socket.on("data", data => {
                ...
                this.log(`< ${response}`);
                // This might be a multiline response. Convert into standlone
