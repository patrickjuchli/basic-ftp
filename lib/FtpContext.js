...
/**
 * @typedef {(response: Error | FTPResponse, task: TaskResolver) => void} ResponseHandler
 */
...
exports.FTPContext = class FTPContext {
    ...
    constructor(timeout = 0, encoding = "utf8") {
         ...
         * @type {(Socket|import("tls").TLSSocket)}
         */
        this._socket;
        /**
         * The current data connection to the FTP server.
         * @type {(Socket | import("tls").TLSSocket | undefined)}
         */
        this._dataSocket;
     ...
     *
     * @private
     * @param {(Error | FTPResponse)} response
     */
