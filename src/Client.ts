...
export class Client {
    ...
    async useDefaultSettings(): Promise<void> {
        ...
        await this.sendIgnoringError("OPTS MLST type;size;perm;modify;unix.mode;unix.owner;unix.group;unix.ownername;unix.groupname") // Make sure MLSD listings include all we can parse
        if (this.ftp.hasTLS) {
