...
![Build Status](https://img.shields.io/github/checks-status/patrickjuchli/basic-ftp/master?label=build) [![npm version](https://img.shields.io/npm/v/basic-ftp.svg)](https://www.npmjs.com/package/basic-ftp)
